      ...
      <div className="mt-9 w-full p-6 rounded-md">
        ...
        <div className="w-full border-[1px] p-4 rounded-md">
          <div>
            ...
            <div
              className="w-full h-[150px] border-[1px] p-2 text-base font-mono"
          ...
          <div className="mt-4">
            ...
            <div
              className="w-full h-[35px]  p-2 text-base font-mono"
            >
          ...
          <div className="mt-4">
            ...
            <div
              className="w-full h-[40px]  p-2 text-base font-mono"
            >
          ...
          <div className="mt-4">
            ...
            <div className="flex space-x-2">
              <div
                className="w-[100px] h-[40px]  p-2 text-base font-mono"
              >
                {formData.month || '3월'}
              </div>
              <div
